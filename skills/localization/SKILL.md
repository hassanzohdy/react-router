...
description: Locale-prefixed URLs, runtime language switching, and locale detection configuration in @mongez/react-router.
when_to_use: User configures localization in setRouterConfigurations(), calls changeLocaleCode(), uses appendLocaleCodeToUrl or autoRedirectToLocaleCode, listens to localeChanged or detects initial locale, or renders locale-aware <Link> components.
---
